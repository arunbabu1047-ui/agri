...
export default function NewsPage() {
  ...
  const filtered = useMemo(() => items.filter((item) => (category === 'all' || item.category_id === category) && `${item.title_en} ${item.title_ta} ${item.summary_en} ${item.summary_ta}`.toLowerCase().includes(query.toLowerCase())), [items, category, query]);
